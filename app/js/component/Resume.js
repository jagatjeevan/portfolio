  ...
  <article className="resume-container">
    ...
    <header className="section">
      ...
      <address>
        ...
        Flat No: C-234, Sls Signature,
        Panathur, Kadubesanahalli,
        Bangalore, KARNATAKA,
        India
        Pin: 560103
      </address>
      <div>
        ...
        <a href="mailto:jagatjeevans@gmail.com">
          jagatjeevans@gmail.com
        </a>
      </div>
      <span>
    ...
    <section>
      ...
      <p>
        I am a UI developer with over 7 years of experience in the industry. I am passionate about learning new trends in the
        market. In my 7yrs of experience, my work majorly consists of analysis, evaluation and executing the design in projects
        using sound engineering principles and adhering to business standards, practices and project requirements. Convert and
        demonstrate new user experience from legacy UI code.
      </p>
    </section>
    <section>
      <h2>
    ...
    <section>
      ...
      <div className="sub-section">
        <h4>UI Developer, Toboc International Pvt. Ltd.. Bangalore, KARNATAKA</h4>
        ...
        <ul>
          ...
          <li>
            ...
            <p>This is a sister website for the above website. This is a website for people in Bangalore for deals to travel addicts and nature explorer. My role included interacting with owners, understanding the patterns and consulting them for better profits.</p>
          </li>
        </ul>
      </div>
      <div className="sub-section">
        ...
        <br />
        <p>During my Freelancing, majority of the work was around creating htmls from static psds. My work would brief in:</p>
        <ul>
          <li>Slight modifications in PSDs and extracting resources (slicing)</li>
